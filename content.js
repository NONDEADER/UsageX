      ...
      <div class="ux-settings-tab-panel" id="ux-tab-panel-system" role="tabpanel" style="display:none;">
        ...
        <div class="ux-settings-section ux-collapsible-section ux-section-collapsed" id="ux-section-support" style="margin-top:0px;">
          ...
          <div class="ux-section-body" style="padding:10px 4px 6px;">
            ...
            <a href="https://github.com/NONDEADER/UsageX/issues" target="_blank" class="ux-settings-btn" style="display:block;text-align:center;text-decoration:none;padding:6px 0;font-weight:600;font-size:10.5px;">Open GitHub Issues</a>
          </div>
        </div>
